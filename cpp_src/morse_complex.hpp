...
Converts cells of one dimension to another based on filtration
...
// std::unordered_set<int> convert_feature_dim(std::unordered_set<int> &feature, int target_dim, Filtration &filt, CellComplex &comp, bool minimal = true) {
